package IOEntscheidungsknopfJRadioButton;
...
public class DecisionData {
	...
	public void saveTextFile(File file) throws IOException {
		fileManager.textSave(file, decisions);
	}

		
	public void loadTextFile(File file) throws ClassNotFoundException, IOException{
		setDecisions(fileManager.textLoad(file));
